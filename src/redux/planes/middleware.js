...
import { planesGetAllFetch, planesByIdFetch, planesAddFetch, planesAddSimpleFetch, planesAddLapsoFetch, planesAddFechaFetch } from "../fetchs";
...
export const middleware = [get, getById, getAll, add, addSimple, addLapso, addFecha, update, patch, remove, processGet, processComand, processError];
