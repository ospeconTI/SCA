...
export const PROTOCOLO_NUEVO = "[entreComponentes] PROTOCOLO_NUEVO";
export const PROTOCOLO_AGREGAR = "[entreComponentes] PROTOCOLO_AGREGAR";

export const protocoloNuevo = (item, accion) => ({
    type: PROTOCOLO_NUEVO,
    item: item,
    accion: accion,
});
export const protocoloAgregar = (item, accion) => ({
    type: PROTOCOLO_AGREGAR,
    item: item,
    accion: accion,
});
